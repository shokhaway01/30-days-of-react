    ...
    <div>
        ...
        <p>
            ...
            <ol>
                ...
                <p>Чтобы узнать количество элементов в массиве изпользуется метод <b>.length0</b> - который показывает сколько в массиве элементов</p>
                <p>А чтобы использовать фильтрацию значений вы можете использовать метод <b>.split</b> - который показывает сколько в массиве элементов</p>
